...
"flat"={matrix(1,Matrix_distance*2+1,Matrix_distance*2+1)},
"circle"={focalWeight(Raster, Matrix_distance*res(Raster), "circle")},
"rectangle"={focalWeight(Raster, Matrix_distanceres(Raster), "rectangle")},
"Gauss"={focalWeight(Raster, Matrix_distance*res(Raster), "Gauss")})
